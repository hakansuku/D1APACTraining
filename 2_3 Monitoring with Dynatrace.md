...
![mobile app](./images/mobile/mobileappcreate.png?raw=true)

Type in name of the mobile application and press 'Create mobile app' button.

![mobile name](./images/mobile/monitor.png?raw=true)

Click 'Instrumentation wizard' and select Android platform

![instrumentation wizard](./images/mobile/mobileappsettings.png?raw=true)
...
![classpathe](./images/mobile/dependencies.png?raw=true)
...
![iactivity_main](./images/mobile/privacy.png?raw=true)

To apply changes, press the below icon to Sync changes in gradle file.

![sync gradle](./images/mobile/synchgradle.png?raw=true)
...
![mobile app](./images/mobile/usertagging.png?raw=true)
...
![mobile app](./images/mobile/scorekey2.png?raw=true)
> You should now have be below score property

![mobile app](./images/mobile/customkey.png?raw=true)
...
![mobile app](./images/mobile/usersession.png?raw=true)
...
![mobile app](./images/mobile/sendscore.png?raw=true)

> Confirm reported value by "send score" custom action in the session. 

![mobile app](./images/mobile/reportedvalue.png?raw=true)
...
```
![mobile app](./images/mobile/query.png?raw=true)
...
![mobile app](./images/mobile/uacm.png?raw=true)
...
![mobile app](./images/mobile/dataexplorer.png?raw=true)
...
![mobile app](./images/mobile/dashboard.png?raw=true)
