...
![installation guide](./images/mobile/newproject.png?raw=true)
...
![installation guide](./images/mobile/Prjemptyview.png?raw=true)
...
![installation guide](./images/mobile/Prjfinish.png?raw=true)
...
![project folder view](./images/mobile/androidappview.png?raw=true)
...
![project folder view select](./images/mobile/folderview.png?raw=true)
...
![project folder view select](./images/mobile/agpupgrade.png?raw=true)
> Select and upgrade the version of Gradle to 8.3.2 using the dropdown. 

![project folder view select](./images/mobile/gradleversion.png?raw=true)
...
![project folder view select](./images/mobile/SDKmanager.png?raw=true)

> Under SDK Platforms tab , select SDK Platform version 34 if not already installed.

![project folder view select](./images/mobile/android14.png?raw=true)
...
![project folder view select](./mobile/androidtools.png?raw=true)
...
![project folder view select](./images/mobile/kotlinplugin.png?raw=true)
...
![Add Device](./images/mobile/tiramisu.png?raw=true)

Click finish

![Add Device](./images/mobile/AVDfinish.png?raw=true)
