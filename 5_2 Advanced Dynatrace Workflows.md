...
![](./images/WORKFLOWS/duplicate.png?raw=true)

- Select first task (get_exchange_rate)
- Click Change action

![](./images/WORKFLOWS/changeaction.png?raw=true)

## Run Javascript action 
- Select Run Javascript action

![](./images/WORKFLOWS/runjavascript.png?raw=true)
...
![](./images/WORKFLOWS/payloadjava.png?raw=true)

- Run the workflow and validate the input of the ingest_filtered_logs task.

![](./images/WORKFLOWS/inputtabjava.png?raw=true)

- Finally validate in logs and events app

![](./images/WORKFLOWS/javafinal.png?raw=true)
